...
export class HomeComponent implements OnInit {
  ...
  creatorAddress: FormArray = new FormArray([new FormControl('', [Validators.maxLength(50)])])
  ...
  createMetadataFile(selectedNftFolderItems: NftItem[], fileName: string){
    ...
    let creatorsArray: SolCreator[] = this.creatorAddress.controls.map(i => <SolCreator>{
      address: i.value,
      share: (100.0 / this.creatorAddress.length)
    });
    ...
    switch(this.blockChain.value){
      case 'ethereum': {
        metadata =  {
          ...
          description,
          fee_recipient: creatorsArray[0].address,
